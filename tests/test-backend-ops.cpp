...
static std::vector<std::unique_ptr<test_case>> make_test_cases_eval() {
    ...
    test_cases.emplace_back(new test_set_rows(GGML_TYPE_F32, GGML_TYPE_TURBO3_0, GGML_TYPE_I64, { 1024, 5, 2, 1 }, { 1, 1 }, 3, false));
...
// Conv_2D test cases
 ...
 // A deep layer of a ConvNet, several images in the batch
    ...
    test_cases.emplace_back(new test_mul_mat_id(GGML_TYPE_Q4_K, GGML_TYPE_F32, 256, 8, true, 512, 1024, 2048));
