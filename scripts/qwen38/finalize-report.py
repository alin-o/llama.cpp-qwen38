...
def main():
    ...
    parser.add_argument("--environment", type=Path, default=Path("qwen38/results/environment.json"))
    parser.add_argument("--preflight", type=Path, default=Path("qwen38/results/artifact-preflight.json"))
    parser.add_argument("--checksums", type=Path, default=Path("qwen38/artifacts.sha256"))
    parser.add_argument("--upstream-lock", type=Path, default=Path("qwen38/upstream.lock"))
    parser.add_argument("--notes", type=Path, default=Path("qwen38/results/evaluation-notes.txt"))
