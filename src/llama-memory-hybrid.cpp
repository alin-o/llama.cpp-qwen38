...
void llama_memory_hybrid::seq_cp_attn(
        llama_seq_id seq_id_src, llama_seq_id seq_id_dst, llama_pos p0, llama_pos p1) {
    mem_attn->seq_cp(seq_id_src, seq_id_dst, p0, p1);
}

size_t llama_memory_hybrid::seq_n_cells_attn(llama_seq_id seq_id) const {
    return mem_attn->seq_n_cells_attn(seq_id);
}

size_t llama_memory_hybrid::seq_n_shared_cells_attn(llama_seq_id seq_id) const {
...
llama_pos llama_memory_hybrid::seq_pos_max_attn(llama_seq_id seq_id) const {
    return mem_attn->seq_pos_max_attn(seq_id);
}

bool llama_memory_hybrid::seq_can_share_attn() const {
    return mem_attn->seq_can_share_attn();
}

size_t llama_memory_hybrid::n_unique_cells_attn(llama_seq_id seq_id_begin, llama_seq_id seq_id_end) const {
    return mem_attn->n_unique_cells_attn(seq_id_begin, seq_id_end);
}

size_t llama_memory_hybrid::n_unique_tokens_attn(llama_seq_id seq_id_begin, llama_seq_id seq_id_end) const {
